...
class GroupModel {
    ...
    static async create(groupData) {
        const { name, description, image, createdBy, disappearingDays } = groupData;
        ...
        try {
            ...
            const [groupResult] = await connection.query(
                `INSERT INTO \`groups\` (name, description, image, created_by, disappearing_days) 
                 VALUES (?, ?, ?, ?, ?)`,
                [name, description || null, image || null, createdBy, disappearingDays || 0]
            );
